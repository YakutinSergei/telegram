...
btn_1: KeyboardButton = KeyboardButton(text=LEXICON_RU['rock']) # Камень
btn_2: KeyboardButton = KeyboardButton(text=LEXICON_RU['scissors']) # Ножницы
btn_3: KeyboardButton = KeyboardButton(text=LEXICON_RU['paper']) # Бумага

# Создаем игровую клавиатуру с кнопками "Камень 🗿",
# "Ножницы ✂" и "Бумага 📜" как список списков

game_kb: ReplyKeyboardMarkup = ReplyKeyboardMarkup(keyboard=[[btn_1], [btn_2], [btn_3]],resize_keyboard=True)
